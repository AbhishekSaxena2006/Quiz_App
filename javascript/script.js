...
questionStatus.innerHTML = `<b>${questionIndexHistory.length}</b> / <b>${numberOfQuestions}</b> Questions`;

// Create option <li> elements, append them, and addd click event listeners
...
const startQuiz = () => {
    ...
    // Update the quiz category and number of qustions
...
// Highlight the selector option on click - category or no. of question
